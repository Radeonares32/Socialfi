  ...
  return (
    <div className="nav-header bg-white shadow-xs border-0">
            <div className="nav-top">
                <a href="default.html"><i className="feather-zap text-success display1-size me-2 ms-0"></i><span className="d-inline-block fredoka-font ls-3 fw-600 text-current font-xxl logo-text mb-0">Sociala. </span> </a>
            ...
            <div className="dropdown-menu dropdown-menu-end p-4 rounded-3 border-0 shadow-lg" aria-labelledby="dropdownMenu3">
                ...
                <div className="card bg-transparent-card w-100 border-0 ps-5 mb-3">
                    <img src="https://via.placeholder.com/50x50.png" alt="user" className="w40 position-absolute left-0"/>
            ...
            <a href="default-settings.html" className="p-0 ms-3 menu-icon"><img src="https://via.placeholder.com/50x50.png" alt="user" className="w40 mt--1"/></a>
